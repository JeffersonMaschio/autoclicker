...
framePosition = ctk.CTkFrame(frameLeft, height=100, fg_color="#222222", border_color="#c0c0c0", border_width=1)
...
frameStart = ctk.CTkFrame(frameLeft, height=100, fg_color="#222222", border_color="#c0c0c0", border_width=1)
